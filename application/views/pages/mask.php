                ...
                <div class="col-sm-6">
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <hr>
                            <span class="price">Layers: <?php echo $product['layer']; ?></span> </div>
                        <div class="col-sm-12"> <span class="code">Item Code: <?php echo $product['item_code']; ?></span>
                            <div class="some-info">
                                <div class="in-stoke" style="text-transform: uppercase;">PROTECTION: <i class="fa fa-check-circle"></i> <?php echo $product['protection']; ?></div>
            ...
            <div class="row"> 
                ...
                foreach ($allproducts as $pkey => $pvalue) {
                    ...
                    <div class="col-sm-4">
                        ...
                        <div class="info"> <a href="<?php echo site_url("mask/".$pkey);?>"><?php echo $pvalue['title']; ?></a> <span class="price"><?php echo $pvalue['item_code']; ?></span> </div>
                    </div>
                    <?php
                }
                ?>
